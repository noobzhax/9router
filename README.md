...
- [🌐 Supported Providers](#-supported-providers)
  ...
  - [🔑 API Key Providers (40+)](#-api-key-providers-40)
- [💡 Key Features](#-key-features)
  - [🚀 RTK Token Saver](#-rtk-token-saver)
  - [🎯 Smart 3-Tier Fallback](#-smart-3-tier-fallback)
  - [📊 Real-Time Quota Tracking](#-real-time-quota-tracking)
  ...
  - [💾 Cloud Sync](#-cloud-sync)
    - [Cloud Runtime Notes](#cloud-runtime-notes)
  - [📊 Usage Analytics](#-usage-analytics)
  - [🌐 Deploy Anywhere](#-deploy-anywhere)
- [💰 Pricing at a Glance](#-pricing-at-a-glance)
  - [📊 Understanding 9Router Costs & Billing](#-understanding-9router-costs-billing)
- [🎯 Use Cases](#-use-cases)
  - [Case 1: "I have Claude Pro subscription"](#case-1-i-have-claude-pro-subscription)
  - [Case 2: "I want zero cost"](#case-2-i-want-zero-cost)
  - [Case 3: "I need 24/7 coding, no interruptions"](#case-3-i-need-247-coding-no-interruptions)
  - [Case 4: "I want FREE AI in OpenClaw"](#case-4-i-want-free-ai-in-openclaw)
...
- [📖 Setup Guide](#-setup-guide)
  ...
  - [GLM-5.1 / GLM-4.7 (Daily reset, $0.6/1M)](#glm-51-glm-47-daily-reset-061m)
  - [MiniMax M2.7 (5h reset, $0.20/1M)](#minimax-m27-5h-reset-0201m)
  - [Kimi K2.5 ($9/month flat)](#kimi-k25-9month-flat)
  - [Kiro AI (Claude 4.5 + GLM-5 + MiniMax FREE)](#kiro-ai-claude-45-glm-5-minimax-free)
  - [OpenCode Free (No auth, auto-fetch models)](#opencode-free-no-auth-auto-fetch-models)
  - [Vertex AI ($300 free credits for new GCP accounts)](#vertex-ai-300-free-credits-for-new-gcp-accounts)
  - [Example 1: Maximize Subscription → Cheap Backup](#example-1-maximize-subscription-cheap-backup)
  - [Example 2: Free-Only (Zero Cost)](#example-2-free-only-zero-cost)
  ...
  - [Runtime Files and Storage](#runtime-files-and-storage)
