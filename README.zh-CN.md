...
- [🤔 为什么选择 9Router？](#-为什么选择-9router)
- [🔄 工作原理](#-工作原理)
- [⚡ 快速开始](#-快速开始)
- [视频教程](#视频教程)
- [🛠️ 支持的 CLI 工具](#-支持的-cli-工具)
- [🌐 支持的提供商](#-支持的提供商)
  - [🔐 OAuth 提供商](#-oauth-提供商)
  - [🆓 免费提供商](#-免费提供商)
  - [🔑 API Key 提供商（40+）](#-api-key-提供商40)
- [💡 主要功能](#-主要功能)
  - [🚀 RTK Token 节省器](#-rtk-token-节省器)
  - [🎯 智能三层切换](#-智能三层切换)
  - [📊 实时配额追踪](#-实时配额追踪)
  - [🔄 格式转换](#-格式转换)
  - [👥 多账户支持](#-多账户支持)
  - [🔄 自动 Token 刷新](#-自动-token-刷新)
  - [🎨 自定义组合](#-自定义组合)
  - [📝 请求日志](#-请求日志)
  - [💾 云同步](#-云同步)
    - [云运行时说明](#云运行时说明)
  ...
  - [🌐 任意部署](#-任意部署)
- [💰 价格一览](#-价格一览)
  - [📊 理解 9Router 成本与计费](#-理解-9router-成本与计费)
- [🎯 使用场景](#-使用场景)
  - [场景 1："我有 Claude Pro 订阅"](#场景-1我有-claude-pro-订阅)
  - [场景 2："我想零成本"](#场景-2我想零成本)
  - [场景 3："我需要 24/7 编码，不中断"](#场景-3我需要-247-编码不中断)
  - [场景 4："我想在 OpenClaw 中使用免费 AI"](#场景-4我想在-openclaw-中使用免费-ai)
- [❓ 常见问题](#-常见问题)
- [📖 设置指南](#-设置指南)
  ...
  - [GLM-5.1 / GLM-4.7（每日重置，$0.6/1M）](#glm-51-glm-47每日重置061m)
  - [MiniMax M2.7（5小时重置，$0.20/1M）](#minimax-m275小时重置0201m)
  - [Kimi K2.5（$9/月固定）](#kimi-k259月固定)
  - [Kiro AI（Claude 4.5 + GLM-5 + MiniMax 免费）](#kiro-aiclaude-45-glm-5-minimax-免费)
  - [OpenCode Free（无需认证，自动获取模型）](#opencode-free无需认证自动获取模型)
  - [Vertex AI（新 GCP 账户 $300 免费额度）](#vertex-ai新-gcp-账户-300-免费额度)
  - [示例 1：充分利用订阅 → 低价备份](#示例-1充分利用订阅-低价备份)
  - [示例 2：仅免费（零成本）](#示例-2仅免费零成本)
