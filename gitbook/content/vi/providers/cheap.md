...
- [Tổng quan](#tổng-quan)
- [GLM-4.7 (Reset Hàng ngày)](#glm-47-reset-hàng-ngày)
  - [Pricing](#pricing)
  - [Setup](#setup)
  - [Model có sẵn](#model-có-sẵn)
  - [Mẹo Pro](#mẹo-pro)
  - [Reset Quota](#reset-quota)
- [MiniMax M2.1 (Reset 5 Giờ)](#minimax-m21-reset-5-giờ)
  - [Pricing](#pricing-1)
  - [Setup](#setup-1)
  - [Model có sẵn](#model-có-sẵn-1)
  - [Mẹo Pro](#mẹo-pro-1)
  - [Reset Quota](#reset-quota-1)
- [Kimi K2 (Cố định $9/tháng)](#kimi-k2-cố-định-9tháng)
  - [Pricing](#pricing-2)
  - [Setup](#setup-2)
  - [Model có sẵn](#model-có-sẵn-2)
  - [Mẹo Pro](#mẹo-pro-2)
  - [Reset Quota](#reset-quota-2)
...
- [Tối ưu Chi phí](#tối-ưu-chi-phí)
  - [Chiến lược 1: Lịch Reset Hàng ngày](#chiến-lược-1-lịch-reset-hàng-ngày)
  - [Chiến lược 2: Ưu tiên Ngân sách](#chiến-lược-2-ưu-tiên-ngân-sách)
  - [Chiến lược 3: Tối đa Subscription Trước](#chiến-lược-3-tối-đa-subscription-trước)
- [Ví dụ Thực tế](#ví-dụ-thực-tế)
  - [Ví dụ 1: Tháng Coding Nặng (100M tokens)](#ví-dụ-1-tháng-coding-nặng-100m-tokens)
  - [Ví dụ 2: Coder Ngân sách ($10/tháng)](#ví-dụ-2-coder-ngân-sách-10tháng)
  - [Ví dụ 3: Freelancer (Usage Biến thiên)](#ví-dụ-3-freelancer-usage-biến-thiên)
- [Best Practices](#best-practices)
  - [1. Theo dõi Quota Hàng ngày](#1-theo-dõi-quota-hàng-ngày)
  - [2. Dùng Coding Plan (GLM)](#2-dùng-coding-plan-glm)
  - [3. Kết hợp với Free Tier](#3-kết-hợp-với-free-tier)
  - [4. Đặt Cảnh báo Ngân sách](#4-đặt-cảnh-báo-ngân-sách)
