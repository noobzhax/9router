...
- [Overview](#overview)
- [GLM-4.7 (Daily Reset)](#glm-47-daily-reset)
  - [Pricing](#pricing)
  - [Setup](#setup)
  - [Available Models](#available-models)
  - [Pro Tips](#pro-tips)
  - [Quota Reset](#quota-reset)
- [MiniMax M2.1 (5-Hour Reset)](#minimax-m21-5-hour-reset)
  - [Pricing](#pricing-1)
  - [Setup](#setup-1)
  - [Available Models](#available-models-1)
  - [Pro Tips](#pro-tips-1)
  - [Quota Reset](#quota-reset-1)
- [Kimi K2 (Flat $9/month)](#kimi-k2-flat-9month)
  - [Pricing](#pricing-2)
  - [Setup](#setup-2)
  - [Available Models](#available-models-2)
  - [Pro Tips](#pro-tips-2)
  - [Quota Reset](#quota-reset-2)
- [Pricing Comparison](#pricing-comparison)
- [Usage Example](#usage-example)
  - [Cursor IDE Setup](#cursor-ide-setup)
  - [Create Combo (Recommended)](#create-combo-recommended)
- [Cost Optimization](#cost-optimization)
  - [Strategy 1: Daily Reset Routine](#strategy-1-daily-reset-routine)
  - [Strategy 2: Budget-First](#strategy-2-budget-first)
  - [Strategy 3: Maximize Subscriptions First](#strategy-3-maximize-subscriptions-first)
- [Real-World Examples](#real-world-examples)
  - [Example 1: Heavy Coding Month (100M tokens)](#example-1-heavy-coding-month-100m-tokens)
  - [Example 2: Budget Coder ($10/month)](#example-2-budget-coder-10month)
  - [Example 3: Freelancer (Variable Usage)](#example-3-freelancer-variable-usage)
- [Best Practices](#best-practices)
  - [1. Track Daily Quota](#1-track-daily-quota)
  - [2. Use Coding Plan (GLM)](#2-use-coding-plan-glm)
  - [3. Combine with Free Tier](#3-combine-with-free-tier)
  - [4. Set Budget Alerts](#4-set-budget-alerts)
