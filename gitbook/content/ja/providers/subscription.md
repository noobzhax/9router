...
- [OpenAI Codex (Plus/Pro)](#openai-codex-pluspro)
  ...
  - [利用可能なモデル](#利用可能なモデル-1)
  - [プロのヒント](#プロのヒント-1)
- [Gemini CLI (月18万無料!)](#gemini-cli-月18万無料)
  - [料金](#料金-2)
  - [セットアップ](#セットアップ-2)
  - [利用可能なモデル](#利用可能なモデル-2)
  - [プロのヒント](#プロのヒント-2)
- [GitHub Copilot](#github-copilot)
  ...
  - [利用可能なモデル](#利用可能なモデル-3)
  - [プロのヒント](#プロのヒント-3)
- [Antigravity (Googleアカウント)](#antigravity-googleアカウント)
  - [料金](#料金-4)
  - [セットアップ](#セットアップ-4)
  - [利用可能なモデル](#利用可能なモデル-4)
  - [プロのヒント](#プロのヒント-4)
- [料金比較](#料金比較)
- [使用例](#使用例)
  - [Cursor IDEセットアップ](#cursor-ideセットアップ)
  - [コンボを作成 (推奨)](#コンボを作成-推奨)
- [クォータトラッキング](#クォータトラッキング)
- [ベストプラクティス](#ベストプラクティス)
  - [1. 無料階層を最初に使用](#1-無料階層を最初に使用)
  - [2. クォータを毎日追跡](#2-クォータを毎日追跡)
  - [3. スマートコンボを作成](#3-スマートコンボを作成)
  - [4. 時間別に最適化](#4-時間別に最適化)
