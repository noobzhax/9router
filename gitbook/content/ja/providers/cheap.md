...
- [概要](#概要)
- [GLM-4.7 (日次リセット)](#glm-47-日次リセット)
  - [料金](#料金)
  - [セットアップ](#セットアップ)
  - [利用可能なモデル](#利用可能なモデル)
  - [プロのヒント](#プロのヒント)
  - [クォータリセット](#クォータリセット)
- [MiniMax M2.1 (5時間リセット)](#minimax-m21-5時間リセット)
  - [料金](#料金-1)
  - [セットアップ](#セットアップ-1)
  - [利用可能なモデル](#利用可能なモデル-1)
  - [プロのヒント](#プロのヒント-1)
  - [クォータリセット](#クォータリセット-1)
- [Kimi K2 (月$9固定)](#kimi-k2-月9固定)
  - [料金](#料金-2)
  - [セットアップ](#セットアップ-2)
  - [利用可能なモデル](#利用可能なモデル-2)
  - [プロのヒント](#プロのヒント-2)
...
- [使用例](#使用例)
  ...
  - [コンボを作成 (推奨)](#コンボを作成-推奨)
- [コスト最適化](#コスト最適化)
  - [戦略1: 日次リセットルーチン](#戦略1-日次リセットルーチン)
  - [戦略2: 予算優先](#戦略2-予算優先)
  - [戦略3: サブスクリプションを最初に最大化](#戦略3-サブスクリプションを最初に最大化)
- [実例](#実例)
  - [例1: 重いコーディング月 (1億トークン)](#例1-重いコーディング月-1億トークン)
  - [例2: バジェットコーダー ($10/月)](#例2-バジェットコーダー-10月)
  - [例3: フリーランサー (変動使用量)](#例3-フリーランサー-変動使用量)
- [ベストプラクティス](#ベストプラクティス)
  - [1. 日次クォータを追跡](#1-日次クォータを追跡)
  - [2. Coding Planを使用 (GLM)](#2-coding-planを使用-glm)
  - [3. 無料階層と組み合わせる](#3-無料階層と組み合わせる)
  - [4. 予算アラートを設定](#4-予算アラートを設定)
