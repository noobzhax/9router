...
- [概要](#概要)
- [iFlow (8つの無料モデル)](#iflow-8つの無料モデル)
  - [料金](#料金)
  - [セットアップ](#セットアップ)
  - [利用可能なモデル](#利用可能なモデル)
  - [プロのヒント](#プロのヒント)
- [Qwen (3つの無料モデル)](#qwen-3つの無料モデル)
  - [料金](#料金-1)
  - [セットアップ](#セットアップ-1)
  - [利用可能なモデル](#利用可能なモデル-1)
  - [プロのヒント](#プロのヒント-1)
- [Kiro (Claude無料)](#kiro-claude無料)
  - [料金](#料金-2)
  - [セットアップ](#セットアップ-2)
  - [利用可能なモデル](#利用可能なモデル-2)
  - [プロのヒント](#プロのヒント-2)
...
- [使用例](#使用例)
  ...
  - [コンボを作成 (推奨)](#コンボを作成-推奨)
- [完全なフォールバック戦略](#完全なフォールバック戦略)
  - [完全な3階層コンボ](#完全な3階層コンボ)
- [ベストプラクティス](#ベストプラクティス)
  - [1. 緊急バックアップとして使用](#1-緊急バックアップとして使用)
  - [2. 適切なモデルを選択](#2-適切なモデルを選択)
  - [3. 無料のみのコンボを作成](#3-無料のみのコンボを作成)
  - [4. 本番前にテスト](#4-本番前にテスト)
- [実例](#実例)
  - [例1: 学生/学習者 (ゼロ予算)](#例1-学生学習者-ゼロ予算)
  - [例2: フリーランサー (予算意識)](#例2-フリーランサー-予算意識)
  - [例3: ヘビーユーザー (すべてを最大化)](#例3-ヘビーユーザー-すべてを最大化)
- [コスト比較](#コスト比較)
  - [シナリオ: 月1億トークン](#シナリオ-月1億トークン)
