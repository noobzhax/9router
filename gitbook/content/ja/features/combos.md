...
- [コンボとは?](#コンボとは)
- [なぜコンボを使うのか?](#なぜコンボを使うのか)
  - [1. サブスクリプション価値を最大化](#1-サブスクリプション価値を最大化)
  - [2. コストを最小化](#2-コストを最小化)
  - [3. 24時間可用性を確保](#3-24時間可用性を確保)
  - [4. 品質に最適化](#4-品質に最適化)
- [コンボの作成方法](#コンボの作成方法)
  - [ステップ1: ダッシュボードを開く](#ステップ1-ダッシュボードを開く)
  - [ステップ2: コンボへ移動](#ステップ2-コンボへ移動)
  - [ステップ3: コンボを設定](#ステップ3-コンボを設定)
  - [ステップ4: 保存](#ステップ4-保存)
  - [ステップ5: CLIで使用](#ステップ5-cliで使用)
- [コンボの例](#コンボの例)
  - [例1: プレミアムコーディング (サブスク → 低価格 → 無料)](#例1-プレミアムコーディング-サブスク-低価格-無料)
  - [例2: バジェットコンボ (低価格 → 無料)](#例2-バジェットコンボ-低価格-無料)
  - [例3: フリーコンボ (ゼロコスト)](#例3-フリーコンボ-ゼロコスト)
  - [例4: 品質優先 (プレミアムモデルのみ)](#例4-品質優先-プレミアムモデルのみ)
  - [例5: マルチサブスクリプション (すべてを最大化)](#例5-マルチサブスクリプション-すべてを最大化)
  - [例6: クォータリセット最適化](#例6-クォータリセット最適化)
- [CLIツールでコンボを使用](#cliツールでコンボを使用)
  ...
  - [APIリクエスト](#apiリクエスト)
- [ベストプラクティス](#ベストプラクティス)
  - [1. 常に無料階層を含める](#1-常に無料階層を含める)
  - [2. コスト順に並べる (安価→高価)](#2-コスト順に並べる-安価高価)
  - [3. 品質要件に合わせる](#3-品質要件に合わせる)
  - [4. クォータリセット時間を考慮](#4-クォータリセット時間を考慮)
  - [5. 異なるユースケース用に複数のコンボを作成](#5-異なるユースケース用に複数のコンボを作成)
  - [6. コンボパフォーマンスをモニター](#6-コンボパフォーマンスをモニター)
- [高度な設定](#高度な設定)
  - [コンボごとに予算上限を設定](#コンボごとに予算上限を設定)
  - [コンボ内のモデルを有効/無効](#コンボ内のモデルを有効無効)
  - [既存のコンボを複製](#既存のコンボを複製)
