...
- [動作の仕組み](#動作の仕組み)
  - [3階層フォールバックシステム](#3階層フォールバックシステム)
- [自動切替](#自動切替)
  - [シナリオ1: サブスクリプションクォータ消費](#シナリオ1-サブスクリプションクォータ消費)
  - [シナリオ2: レート制限](#シナリオ2-レート制限)
  - [シナリオ3: プロバイダー利用不可](#シナリオ3-プロバイダー利用不可)
- [モデル選択ロジック](#モデル選択ロジック)
  - [優先順位の例](#優先順位の例)
- [設定オプション](#設定オプション)
  - [ダッシュボード設定](#ダッシュボード設定)
- [例](#例)
  - [例1: 基本的な自動フォールバック](#例1-基本的な自動フォールバック)
  - [例2: 予算意識のルーティング](#例2-予算意識のルーティング)
  - [例3: サブスクリプションのみモード](#例3-サブスクリプションのみモード)
  - [例4: 無料のみモード](#例4-無料のみモード)
- [ベストプラクティス](#ベストプラクティス)
...
- [モニタリングとアラート](#モニタリングとアラート)
  - [ダッシュボードクォータトラッカー](#ダッシュボードクォータトラッカー)
  - [リアルタイム通知](#リアルタイム通知)
  - [使用統計](#使用統計)
