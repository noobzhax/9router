...
- [ダッシュボード概要](#ダッシュボード概要)
  - [クォータサマリー](#クォータサマリー)
- [リアルタイムトークン消費](#リアルタイムトークン消費)
  - [リクエストごとのトラッキング](#リクエストごとのトラッキング)
  - [ライブ使用量モニター](#ライブ使用量モニター)
  - [モデル別のトークン内訳](#モデル別のトークン内訳)
- [クォータ上限とリセット時間](#クォータ上限とリセット時間)
  - [サブスクリプションプロバイダー](#サブスクリプションプロバイダー)
  - [低価格プロバイダー](#低価格プロバイダー)
  - [無料プロバイダー](#無料プロバイダー)
- [コスト見積もり](#コスト見積もり)
  - [リアルタイムコストトラッキング](#リアルタイムコストトラッキング)
  - [月次支出レポート](#月次支出レポート)
  - [コスト予測](#コスト予測)
- [使用量ダッシュボード](#使用量ダッシュボード)
  - [概要統計](#概要統計)
  - [モデル別使用量](#モデル別使用量)
  - [時間別使用量](#時間別使用量)
  - [コンボ別使用量](#コンボ別使用量)
- [アラートと通知](#アラートと通知)
  ...
  - [コスト異常検知](#コスト異常検知)
- [ベストプラクティス](#ベストプラクティス)
  - [1. クォータを毎日モニター](#1-クォータを毎日モニター)
  - [2. 予算上限を設定](#2-予算上限を設定)
  - [3. コンボ使用を最適化](#3-コンボ使用を最適化)
  - [4. リセット時間を追跡](#4-リセット時間を追跡)
  - [5. 月次レポートを確認](#5-月次レポートを確認)
- [APIアクセス](#apiアクセス)
  - [クォータステータスを取得](#クォータステータスを取得)
  - [使用統計を取得](#使用統計を取得)
