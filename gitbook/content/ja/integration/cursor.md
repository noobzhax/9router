...
- [⚠️ 重要な注意点](#-重要な注意点)
- [セットアップ](#セットアップ)
  - [1. Cursor設定を開く](#1-cursor設定を開く)
  - [2. OpenAI APIを有効化](#2-openai-apiを有効化)
  - [3. Base URLを設定](#3-base-urlを設定)
  - [4. APIキーを追加](#4-apiキーを追加)
  - [5. カスタムモデルを追加](#5-カスタムモデルを追加)
  - [6. モデルを選択](#6-モデルを選択)
- [設定例](#設定例)
- [利用可能なモデル](#利用可能なモデル)
- [使用法](#使用法)
  - [チャットインターフェイス](#チャットインターフェイス)
  - [インラインコード生成](#インラインコード生成)
  - [コード説明](#コード説明)
- [トラブルシューティング](#トラブルシューティング)
  - [「Invalid API Key」エラー](#invalid-api-keyエラー)
  - [「Model Not Found」エラー](#model-not-foundエラー)
  - [接続の問題](#接続の問題)
  - [Localhostが動作しない](#localhostが動作しない)
- [クラウドエンドポイントのセットアップ](#クラウドエンドポイントのセットアップ)
- [ベストプラクティス](#ベストプラクティス)
