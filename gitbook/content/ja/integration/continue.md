...
- [前提条件](#前提条件)
- [設定手順](#設定手順)
  - [1. Continue設定を開く](#1-continue設定を開く)
  - [2. 9Routerモデル設定を追加](#2-9routerモデル設定を追加)
  - [3. 保存してリロード](#3-保存してリロード)
  - [4. モデルを選択](#4-モデルを選択)
- [利用可能なモデル](#利用可能なモデル)
...
- [高度な設定](#高度な設定)
  ...
  - [Temperatureとパラメータ](#temperatureとパラメータ)
  - [コンテキストプロバイダー](#コンテキストプロバイダー)
- [キーボードショートカット](#キーボードショートカット)
- [トラブルシューティング](#トラブルシューティング)
  - [モデルが応答しない](#モデルが応答しない)
  - [間違ったモデルが選択されている](#間違ったモデルが選択されている)
  - [設定が読み込まれない](#設定が読み込まれない)
  - [パフォーマンスが遅い](#パフォーマンスが遅い)
- [ベストプラクティス](#ベストプラクティス)
  - [モデル選択戦略](#モデル選択戦略)
  - [コンテキスト管理](#コンテキスト管理)
  - [コスト最適化](#コスト最適化)
