...
- [前提条件](#前提条件)
- [セットアップ](#セットアップ)
  - [1. Cline設定を開く](#1-cline設定を開く)
  - [2. APIプロバイダーを選択](#2-apiプロバイダーを選択)
...
- [トラブルシューティング](#トラブルシューティング)
  - [「Connection Failed」エラー](#connection-failedエラー)
  - [「Invalid API Key」エラー](#invalid-api-keyエラー)
  - [「Model Not Found」エラー](#model-not-foundエラー)
  - [Clineが応答しない](#clineが応答しない)
- [高度な設定](#高度な設定)
  - [クラウドエンドポイントを使用](#クラウドエンドポイントを使用)
  - [複数のモデル](#複数のモデル)
  - [カスタムタイムアウト](#カスタムタイムアウト)
- [ベストプラクティス](#ベストプラクティス)
- [9Router機能との統合](#9router機能との統合)
  - [モデルルーティング](#モデルルーティング)
  - [フォールバックサポート](#フォールバックサポート)
  - [使用量トラッキング](#使用量トラッキング)
