...
- [概要](#概要)
- [汎用セットアップパターン](#汎用セットアップパターン)
- [利用可能なモデル](#利用可能なモデル)
  - [Claudeモデル (Anthropic)](#claudeモデル-anthropic)
  - [DeepSeekモデル](#deepseekモデル)
  - [GLMモデル (Zhipu AI)](#glmモデル-zhipu-ai)
- [統合例](#統合例)
  - [PythonとOpenAI SDK](#pythonとopenai-sdk)
  - [Node.jsとOpenAI SDK](#nodejsとopenai-sdk)
  - [cURLコマンド](#curlコマンド)
  - [HTTPクライアント (Postman、Insomnia)](#httpクライアント-postmaninsomnia)
  - [LangChain統合](#langchain統合)
  - [LlamaIndex統合](#llamaindex統合)
- [カスタムスクリプトの例](#カスタムスクリプトの例)
  - [バッチ処理スクリプト](#バッチ処理スクリプト)
  - [ストリーミングレスポンスハンドラ](#ストリーミングレスポンスハンドラ)
  - [マルチモデル比較](#マルチモデル比較)
- [一般的な統合パターン](#一般的な統合パターン)
  - [環境変数](#環境変数)
  - [エラーハンドリング](#エラーハンドリング)
  - [リトライロジック](#リトライロジック)
