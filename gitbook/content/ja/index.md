...
- [9Routerとは?](#9routerとは)
- [主な機能](#主な機能)
  - [🔄 スマート3階層フォールバック](#-スマート3階層フォールバック)
  - [📊 クォータトラッキング](#-クォータトラッキング)
  - [🎯 ユニバーサルCLIサポート](#-ユニバーサルcliサポート)
  - [💰 コスト最適化](#-コスト最適化)
- [なぜ9Routerを選ぶのか?](#なぜ9routerを選ぶのか)
  - [サブスクリプションを最大化](#サブスクリプションを最大化)
  - [超低価格バックアップ](#超低価格バックアップ)
  - [永久無料フォールバック](#永久無料フォールバック)
- [クイックスタート](#クイックスタート)
- [ユースケース](#ユースケース)
  - [個人開発者向け](#個人開発者向け)
  - [チーム向け](#チーム向け)
  - [モバイル/リモートコーディング向け](#モバイルリモートコーディング向け)
- [次は?](#次は)
