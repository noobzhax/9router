...
- [🖥️ VPSデプロイメント](#-vpsデプロイメント)
  - [前提条件](#前提条件)
  - [ステップ1: リポジトリをクローン](#ステップ1-リポジトリをクローン)
  - [ステップ2: 依存関係をインストール](#ステップ2-依存関係をインストール)
  - [ステップ3: アプリケーションをビルド](#ステップ3-アプリケーションをビルド)
  - [ステップ4: 環境変数を設定](#ステップ4-環境変数を設定)
  - [ステップ5: データディレクトリを作成](#ステップ5-データディレクトリを作成)
  - [ステップ6: アプリケーションを起動](#ステップ6-アプリケーションを起動)
  - [ステップ7: 本番環境用にPM2をセットアップ](#ステップ7-本番環境用にpm2をセットアップ)
- [🐳 Dockerデプロイメント](#-dockerデプロイメント)
  - [オプション1: Dockerfileを使用](#オプション1-dockerfileを使用)
  - [オプション2: Docker Compose](#オプション2-docker-compose)
- [🌐 Nginxリバースプロキシ](#-nginxリバースプロキシ)
  - [Nginxを使う理由](#nginxを使う理由)
  - [ステップ1: Nginxをインストール](#ステップ1-nginxをインストール)
  - [ステップ2: Nginxを設定](#ステップ2-nginxを設定)
  - [ステップ3: サイトを有効化](#ステップ3-サイトを有効化)
  - [ステップ4: Let's EncryptでSSLをセットアップ](#ステップ4-lets-encryptでsslをセットアップ)
- [🔒 セキュリティ考慮事項](#-セキュリティ考慮事項)
  - [1. デフォルト認証情報を変更](#1-デフォルト認証情報を変更)
  - [2. ファイアウォール設定](#2-ファイアウォール設定)
  - [3. ダッシュボードアクセスを制限](#3-ダッシュボードアクセスを制限)
  - [4. 定期的な更新](#4-定期的な更新)
  - [5. バックアップ戦略](#5-バックアップ戦略)
- [📊 モニタリング](#-モニタリング)
  - [アプリケーションステータスを確認](#アプリケーションステータスを確認)
  - [Nginxログ](#nginxログ)
  - [システムリソース](#システムリソース)
- [🚨 トラブルシューティング](#-トラブルシューティング)
  - [アプリケーションが起動しない](#アプリケーションが起動しない)
  - [Nginx 502 Bad Gateway](#nginx-502-bad-gateway)
  - [SSEストリーミングが動作しない](#sseストリーミングが動作しない)
  - [Permission Deniedエラー](#permission-deniedエラー)
- [🔗 次のステップ](#-次のステップ)
