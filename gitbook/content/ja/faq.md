...
- [9Routerとは?](#9routerとは)
- [料金体系はどうなっていますか?](#料金体系はどうなっていますか)
  - [Tier 1: サブスクリプション(最初に最大化)](#tier-1-サブスクリプション最初に最大化)
  - [Tier 2: 低価格(バックアップ)](#tier-2-低価格バックアップ)
  - [Tier 3: 無料(緊急時)](#tier-3-無料緊急時)
- [9Routerは無料ですか?](#9routerは無料ですか)
- [どのプロバイダーがサポートされていますか?](#どのプロバイダーがサポートされていますか)
  - [サブスクリプションプロバイダー](#サブスクリプションプロバイダー)
  - [低価格プロバイダー](#低価格プロバイダー)
  - [無料プロバイダー](#無料プロバイダー)
- [複数のプロバイダーを使用できますか?](#複数のプロバイダーを使用できますか)
- [クォータトラッキングはどのように機能しますか?](#クォータトラッキングはどのように機能しますか)
- [9RouterはCursorで動作しますか?](#9routerはcursorで動作しますか)
- [9Routerをセルフホストできますか?](#9routerをセルフホストできますか)
  - [Localhost(デフォルト)](#localhostデフォルト)
  - [VPS/クラウド](#vpsクラウド)
  - [Docker](#docker)
  - [Cloudflare Workers](#cloudflare-workers)
- [データは安全ですか?](#データは安全ですか)
- [9Routerを更新するには?](#9routerを更新するには)
  - [グローバルNPMインストール](#グローバルnpmインストール)
