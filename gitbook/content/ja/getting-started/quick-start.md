...
- [クイックスタート](#クイックスタート)
  - [1. インストール](#1-インストール)
  - [2. 起動](#2-起動)
  - [3. プロバイダーを接続](#3-プロバイダーを接続)
    - [オプションA: OAuth(サブスクリプションプロバイダー)](#オプションa-oauthサブスクリプションプロバイダー)
    - [オプションB: APIキー(低価格プロバイダー)](#オプションb-apiキー低価格プロバイダー)
    - [オプションC: 無料プロバイダー(コストなし)](#オプションc-無料プロバイダーコストなし)
- [4. CLIツールで使用](#4-cliツールで使用)
  - [Cursor IDE](#cursor-ide)
  - [Claude Desktop](#claude-desktop)
  - [Cline / Continue / RooCode](#cline-continue-roocode)
  - [Codex CLI](#codex-cli)
- [5. スマートコンボを作成(オプション)](#5-スマートコンボを作成オプション)
- [利用可能なモデル](#利用可能なモデル)
  - [サブスクリプションモデル(最初に最大化)](#サブスクリプションモデル最初に最大化)
  - [低価格モデル(バックアップ)](#低価格モデルバックアップ)
  - [無料モデル(緊急時)](#無料モデル緊急時)
- [コスト最適化戦略](#コスト最適化戦略)
  - [月予算: $10〜20/月](#月予算-1020月)
  - [クォータリセット戦略](#クォータリセット戦略)
- [次のステップ](#次のステップ)
- [ヘルプが必要?](#ヘルプが必要)
