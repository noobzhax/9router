...
- [要件](#要件)
  ...
  - [バージョンを確認](#バージョンを確認)
- [インストール方法](#インストール方法)
  - [方法1: グローバルインストール (推奨)](#方法1-グローバルインストール-推奨)
  - [方法2: ローカルインストール](#方法2-ローカルインストール)
  - [方法3: ソースから (開発)](#方法3-ソースから-開発)
- [初回実行](#初回実行)
  - [サーバーを起動](#サーバーを起動)
  - [ダッシュボードログイン](#ダッシュボードログイン)
  - [APIキーを取得](#apiキーを取得)
- [インストールを確認](#インストールを確認)
  - [サーバーステータスを確認](#サーバーステータスを確認)
  - [利用可能なモデルを一覧表示](#利用可能なモデルを一覧表示)
  - [チャットコンプリーションをテスト](#チャットコンプリーションをテスト)
- [設定](#設定)
  - [環境変数](#環境変数)
  - [データディレクトリ](#データディレクトリ)
  - [ポート設定](#ポート設定)
- [トラブルシューティング](#トラブルシューティング)
  - [ポートがすでに使用されている](#ポートがすでに使用されている)
  - [Permission Denied](#permission-denied)
  - [Node.jsバージョンが古すぎる](#nodejsバージョンが古すぎる)
  - [ダッシュボードが開かない](#ダッシュボードが開かない)
  - [プロバイダーに接続できない](#プロバイダーに接続できない)
  - [高メモリ使用量](#高メモリ使用量)
- [デプロイメントオプション](#デプロイメントオプション)
  - [ローカル開発](#ローカル開発)
  - [VPS/クラウドサーバー](#vpsクラウドサーバー)
  - [Docker](#docker)
  - [リバースプロキシ (Nginx)](#リバースプロキシ-nginx)
- [アンインストール](#アンインストール)
  - [グローバルインストールを削除](#グローバルインストールを削除)
  - [データディレクトリを削除](#データディレクトリを削除)
  - [設定を削除](#設定を削除)
- [次のステップ](#次のステップ)
- [ヘルプが必要?](#ヘルプが必要)
