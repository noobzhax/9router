...
- [概览](#概览)
- [iFlow(8 个免费模型)](#iflow8-个免费模型)
  - [价格](#价格)
  - [设置](#设置)
  - [可用模型](#可用模型)
  - [专业建议](#专业建议)
- [Qwen(3 个免费模型)](#qwen3-个免费模型)
  - [价格](#价格-1)
  - [设置](#设置-1)
  - [可用模型](#可用模型-1)
  - [专业建议](#专业建议-1)
- [Kiro(免费 Claude)](#kiro免费-claude)
  - [价格](#价格-2)
  - [设置](#设置-2)
  - [可用模型](#可用模型-2)
  - [专业建议](#专业建议-2)
...
- [最佳实践](#最佳实践)
  ...
  - [4. 上生产前先测试](#4-上生产前先测试)
- [真实案例](#真实案例)
  - [案例 1:学生/学习者(零预算)](#案例-1学生学习者零预算)
  - [案例 2:自由职业(预算敏感)](#案例-2自由职业预算敏感)
  - [案例 3:重度用户(全部最大化)](#案例-3重度用户全部最大化)
- [成本对比](#成本对比)
  - [场景:每月 100M tokens](#场景每月-100m-tokens)
- [故障排除](#故障排除)
