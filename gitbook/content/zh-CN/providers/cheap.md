...
- [概览](#概览)
- [GLM-4.7(每日重置)](#glm-47每日重置)
  - [价格](#价格)
  - [设置](#设置)
  - [可用模型](#可用模型)
  - [专业建议](#专业建议)
  - [配额重置](#配额重置)
- [MiniMax M2.1(5 小时重置)](#minimax-m215-小时重置)
  - [价格](#价格-1)
  - [设置](#设置-1)
  - [可用模型](#可用模型-1)
  - [专业建议](#专业建议-1)
  - [配额重置](#配额重置-1)
- [Kimi K2(固定 $9/月)](#kimi-k2固定-9月)
  - [价格](#价格-2)
  - [设置](#设置-2)
  - [可用模型](#可用模型-2)
  - [专业建议](#专业建议-2)
...
- [使用示例](#使用示例)
  ...
  - [创建组合(推荐)](#创建组合推荐)
- [成本优化](#成本优化)
  - [策略 1:每日重置例程](#策略-1每日重置例程)
  - [策略 2:预算优先](#策略-2预算优先)
  - [策略 3:订阅优先最大化](#策略-3订阅优先最大化)
- [真实案例](#真实案例)
  - [案例 1:重度编码月(100M tokens)](#案例-1重度编码月100m-tokens)
  - [案例 2:预算编码者($10/月)](#案例-2预算编码者10月)
  - [案例 3:自由职业(用量浮动)](#案例-3自由职业用量浮动)
- [最佳实践](#最佳实践)
  - [1. 跟踪每日配额](#1-跟踪每日配额)
  - [2. 使用 Coding Plan(GLM)](#2-使用-coding-planglm)
  - [3. 结合免费层](#3-结合免费层)
  - [4. 设置预算告警](#4-设置预算告警)
- [故障排除](#故障排除)
