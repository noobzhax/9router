...
- [什么是 9Router?](#什么是-9router)
- [价格是如何计算的?](#价格是如何计算的)
  - [第 1 层:订阅(优先使用)](#第-1-层订阅优先使用)
  - [第 2 层:低价(备用)](#第-2-层低价备用)
  - [第 3 层:免费(应急)](#第-3-层免费应急)
- [9Router 是免费的吗?](#9router-是免费的吗)
- [支持哪些提供商?](#支持哪些提供商)
  - [订阅型提供商](#订阅型提供商)
  - [低价提供商](#低价提供商)
  - [免费提供商](#免费提供商)
- [可以同时使用多个提供商吗?](#可以同时使用多个提供商吗)
- [配额跟踪是如何工作的?](#配额跟踪是如何工作的)
- [9Router 能配合 Cursor 使用吗?](#9router-能配合-cursor-使用吗)
- [可以自托管 9Router 吗?](#可以自托管-9router-吗)
  - [Localhost(默认)](#localhost默认)
  - [VPS/云](#vps云)
  - [Docker](#docker)
  - [Cloudflare Workers](#cloudflare-workers)
- [我的数据安全吗?](#我的数据安全吗)
- [如何更新 9Router?](#如何更新-9router)
  - [全局 NPM 安装](#全局-npm-安装)
  - [本地安装](#本地安装)
  - [Docker](#docker-1)
- [如何贡献?](#如何贡献)
