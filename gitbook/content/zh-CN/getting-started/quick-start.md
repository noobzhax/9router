...
- [快速开始](#快速开始)
  ...
  - [2. 启动](#2-启动)
  - [3. 连接提供商](#3-连接提供商)
    - [方式 A:OAuth(订阅型提供商)](#方式-aoauth订阅型提供商)
    - [方式 B:API Key(低价提供商)](#方式-bapi-key低价提供商)
    - [方式 C:免费提供商(零成本)](#方式-c免费提供商零成本)
- [4. 在 CLI 工具中使用](#4-在-cli-工具中使用)
  - [Cursor IDE](#cursor-ide)
  - [Claude Desktop](#claude-desktop)
  - [Cline / Continue / RooCode](#cline-continue-roocode)
  - [Codex CLI](#codex-cli)
- [5. 创建智能组合(可选)](#5-创建智能组合可选)
- [可用模型](#可用模型)
  - [订阅型模型(优先使用)](#订阅型模型优先使用)
  - [低价模型(备用)](#低价模型备用)
  - [免费模型(应急)](#免费模型应急)
- [成本优化策略](#成本优化策略)
  - [月度预算:$10-20/月](#月度预算10-20月)
  - [配额重置策略](#配额重置策略)
- [下一步](#下一步)
- [需要帮助?](#需要帮助)
