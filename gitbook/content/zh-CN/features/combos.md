...
- [为什么使用组合?](#为什么使用组合)
  - [1. 最大化订阅价值](#1-最大化订阅价值)
  - [2. 最小化成本](#2-最小化成本)
  - [3. 保障 24/7 可用](#3-保障-247-可用)
  - [4. 质量优化](#4-质量优化)
- [如何创建组合](#如何创建组合)
  - [步骤 1:打开仪表盘](#步骤-1打开仪表盘)
  - [步骤 2:进入组合页面](#步骤-2进入组合页面)
  - [步骤 3:配置组合](#步骤-3配置组合)
  - [步骤 4:保存](#步骤-4保存)
  - [步骤 5:在 CLI 中使用](#步骤-5在-cli-中使用)
- [示例组合](#示例组合)
  - [示例 1:Premium Coding(订阅 → 低价 → 免费)](#示例-1premium-coding订阅-低价-免费)
  - [示例 2:Budget Combo(低价 → 免费)](#示例-2budget-combo低价-免费)
  - [示例 3:Free Combo(零成本)](#示例-3free-combo零成本)
  - [示例 4:Quality First(仅高端模型)](#示例-4quality-first仅高端模型)
  - [示例 5:Multi-Subscription(用足所有订阅)](#示例-5multi-subscription用足所有订阅)
  - [示例 6:配额重置优化](#示例-6配额重置优化)
- [在 CLI 工具中使用组合](#在-cli-工具中使用组合)
...
- [最佳实践](#最佳实践)
  - [1. 总是包含免费层](#1-总是包含免费层)
  - [2. 按成本排序(便宜 → 贵)](#2-按成本排序便宜-贵)
  - [3. 匹配质量要求](#3-匹配质量要求)
  - [4. 考虑配额重置时间](#4-考虑配额重置时间)
  - [5. 为不同场景创建多个组合](#5-为不同场景创建多个组合)
  - [6. 监控组合性能](#6-监控组合性能)
- [高级配置](#高级配置)
  - [为组合设置预算上限](#为组合设置预算上限)
  - [启用/禁用组合中的模型](#启用禁用组合中的模型)
  - [克隆已有组合](#克隆已有组合)
- [故障排除](#故障排除)
- [相关](#相关)
