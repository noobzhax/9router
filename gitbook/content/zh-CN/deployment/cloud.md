...
- [🖥️ VPS 部署](#-vps-部署)
  ...
  - [步骤 2:安装依赖](#步骤-2安装依赖)
  - [步骤 3:构建应用](#步骤-3构建应用)
  - [步骤 4:配置环境变量](#步骤-4配置环境变量)
  - [步骤 5:创建数据目录](#步骤-5创建数据目录)
  - [步骤 6:启动应用](#步骤-6启动应用)
  - [步骤 7:用 PM2 部署到生产环境](#步骤-7用-pm2-部署到生产环境)
- [🐳 Docker 部署](#-docker-部署)
  - [方式 1:使用 Dockerfile](#方式-1使用-dockerfile)
  - [方式 2:Docker Compose](#方式-2docker-compose)
- [🌐 Nginx 反向代理](#-nginx-反向代理)
  - [为什么使用 Nginx?](#为什么使用-nginx)
  - [步骤 1:安装 Nginx](#步骤-1安装-nginx)
  - [步骤 2:配置 Nginx](#步骤-2配置-nginx)
  - [步骤 3:启用站点](#步骤-3启用站点)
  - [步骤 4:使用 Let's Encrypt 配置 SSL](#步骤-4使用-lets-encrypt-配置-ssl)
- [🔒 安全注意事项](#-安全注意事项)
  - [1. 修改默认凭据](#1-修改默认凭据)
  - [2. 防火墙配置](#2-防火墙配置)
  - [3. 限制仪表盘访问](#3-限制仪表盘访问)
