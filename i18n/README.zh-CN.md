...
- [⚡ 快速开始](#-快速开始)
- [🎥 视频教程](#-视频教程)
  - [📺完整设置指南 - 9Router + Claude Code 免费](#完整设置指南---9router-claude-code-免费)
- [🛠️ 支持的 CLI 工具](#-支持的-cli-工具)
- [🌐 支持的提供商](#-支持的提供商)
  - [🔐 OAuth 提供商](#-oauth-提供商)
  - [🆓 免费提供商](#-免费提供商)
  - [🔑 API Key 提供商 (40+)](#-api-key-提供商-40)
- [💡 核心特性](#-核心特性)
  - [🎯 智能 3 层回退](#-智能-3-层回退)
  - [📊 实时配额追踪](#-实时配额追踪)
  - [🔄 格式转换](#-格式转换)
  ...
  - [🌐 随处部署](#-随处部署)
- [💰 定价一览](#-定价一览)
  - [📊 理解 9Router 成本和计费](#-理解-9router-成本和计费)
  - [示例 1：最大化订阅 → 廉价备份](#示例-1最大化订阅-廉价备份)
