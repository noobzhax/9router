...
- [⚡ クイックスタート](#-クイックスタート)
- [🎥 動画チュートリアル](#-動画チュートリアル)
  - [📺 完全セットアップガイド - 9Router + Claude Code 無料](#-完全セットアップガイド---9router-claude-code-無料)
- [🛠️ 対応CLIツール](#-対応cliツール)
- [🌐 対応プロバイダー](#-対応プロバイダー)
  - [🔐 OAuthプロバイダー](#-oauthプロバイダー)
  - [🆓 無料プロバイダー](#-無料プロバイダー)
  - [🔑 APIキープロバイダー（40以上）](#-apiキープロバイダー40以上)
- [💡 主な機能](#-主な機能)
  - [🎯 スマート3段階フォールバック](#-スマート3段階フォールバック)
  - [📊 リアルタイムクオータ追跡](#-リアルタイムクオータ追跡)
  - [🔄 フォーマット変換](#-フォーマット変換)
  - [👥 マルチアカウント対応](#-マルチアカウント対応)
  - [🔄 自動トークンリフレッシュ](#-自動トークンリフレッシュ)
  - [🎨 カスタムコンボ](#-カスタムコンボ)
  - [📝 リクエストログ](#-リクエストログ)
  - [💾 クラウド同期](#-クラウド同期)
    - [クラウドランタイムに関する注意](#クラウドランタイムに関する注意)
  - [📊 使用状況分析](#-使用状況分析)
  - [🌐 どこでもデプロイ](#-どこでもデプロイ)
- [💰 料金の概要](#-料金の概要)
  - [📊 9Routerのコストと課金について](#-9routerのコストと課金について)
- [🎯 ユースケース](#-ユースケース)
  - [ケース1: 「Claude Proサブスクリプションを持っている」](#ケース1-claude-proサブスクリプションを持っている)
  - [ケース2: 「コストゼロにしたい」](#ケース2-コストゼロにしたい)
  - [ケース3: 「24時間365日コーディング、中断なし」](#ケース3-24時間365日コーディング中断なし)
  - [ケース4: 「OpenClawで無料AIを使いたい」](#ケース4-openclawで無料aiを使いたい)
- [❓ よくある質問](#-よくある質問)
- [📖 セットアップガイド](#-セットアップガイド)
  - [Claude Code (Pro/Max)](#claude-code-promax)
  - [OpenAI Codex (Plus/Pro)](#openai-codex-pluspro)
  - [Gemini CLI（月18万回無料！）](#gemini-cli月18万回無料)
  - [GitHub Copilot](#github-copilot)
  - [GLM-4.7（日次リセット、$0.6/1M）](#glm-47日次リセット061m)
  - [MiniMax M2.1（5時間リセット、$0.20/1M）](#minimax-m215時間リセット0201m)
  - [Kimi K2（月額$9固定）](#kimi-k2月額9固定)
  - [iFlow（8つの無料モデル）](#iflow8つの無料モデル)
  - [Qwen（3つの無料モデル）](#qwen3つの無料モデル)
  - [Kiro（Claude無料）](#kiroclaude無料)
  - [例1: サブスクリプション最大化 → 格安バックアップ](#例1-サブスクリプション最大化-格安バックアップ)
  - [例2: 無料のみ（コストゼロ）](#例2-無料のみコストゼロ)
  ...
  - [Docker](#docker)
  - [環境変数](#環境変数)
  - [ランタイムファイルとストレージ](#ランタイムファイルとストレージ)
- [📊 利用可能なモデル](#-利用可能なモデル)
