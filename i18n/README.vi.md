...
- [🎥 Hướng dẫn Video](#-hướng-dẫn-video)
  - [📺 Hướng dẫn thiết lập hoàn chỉnh - 9Router + Claude Code MIỄN PHÍ](#-hướng-dẫn-thiết-lập-hoàn-chỉnh---9router-claude-code-miễn-phí)
- [🛠️ Các công cụ CLI được hỗ trợ](#-các-công-cụ-cli-được-hỗ-trợ)
- [Các nhà cung cấp được hỗ trợ](#các-nhà-cung-cấp-được-hỗ-trợ)
  - [🔐 Các nhà cung cấp OAuth](#-các-nhà-cung-cấp-oauth)
  - [🆓 Các nhà cung cấp Miễn phí](#-các-nhà-cung-cấp-miễn-phí)
  - [🔑 Các nhà cung cấp API Key (40+)](#-các-nhà-cung-cấp-api-key-40)
- [💡 Các tính năng chính](#-các-tính-năng-chính)
  - [🎯 Smart 3-Tier Fallback](#-smart-3-tier-fallback)
  - [📊 Theo dõi hạn mức thời gian thực](#-theo-dõi-hạn-mức-thời-gian-thực)
  - [🔄 Dịch chuyển định dạng](#-dịch-chuyển-định-dạng)
  - [👥 Hỗ trợ Đa tài khoản](#-hỗ-trợ-đa-tài-khoản)
  - [🔄 Tự động làm mới Token](#-tự-động-làm-mới-token)
  - [🎨 Combo tùy chỉnh](#-combo-tùy-chỉnh)
  - [📝 Ghi log Request](#-ghi-log-request)
  - [💾 Đồng bộ đám mây](#-đồng-bộ-đám-mây)
    - [Ghi chú Runtime Đám mây](#ghi-chú-runtime-đám-mây)
  - [📊 Phân tích sử dụng](#-phân-tích-sử-dụng)
  - [🌐 Triển khai ở bất cứ đâu](#-triển-khai-ở-bất-cứ-đâu)
- [💰 Tổng quan về giá](#-tổng-quan-về-giá)
  - [📊 Hiểu về Chi phí & Thanh toán của 9Router](#-hiểu-về-chi-phí-thanh-toán-của-9router)
- [🎯 Trường hợp sử dụng](#-trường-hợp-sử-dụng)
  - [Trường hợp 1: "Tôi có gói đăng ký Claude Pro"](#trường-hợp-1-tôi-có-gói-đăng-ký-claude-pro)
  - [Trường hợp 2: "Tôi muốn chi phí bằng không"](#trường-hợp-2-tôi-muốn-chi-phí-bằng-không)
  - [Trường hợp 3: "Tôi cần code 24/7, không gián đoạn"](#trường-hợp-3-tôi-cần-code-247-không-gián-đoạn)
  - [Trường hợp 4: "Tôi muốn AI MIỄN PHÍ trong OpenClaw"](#trường-hợp-4-tôi-muốn-ai-miễn-phí-trong-openclaw)
- [❓ Các câu hỏi thường gặp](#-các-câu-hỏi-thường-gặp)
- [📖 Hướng dẫn thiết lập](#-hướng-dẫn-thiết-lập)
  - [Claude Code (Pro/Max)](#claude-code-promax)
  - [OpenAI Codex (Plus/Pro)](#openai-codex-pluspro)
  - [Gemini CLI (MIỄN PHÍ 180K/tháng!)](#gemini-cli-miễn-phí-180ktháng)
  - [GitHub Copilot](#github-copilot)
  - [Claude Code](#claude-code)
  - [Codex CLI](#codex-cli)
  - [OpenClaw](#openclaw)
  - [Cline / Continue / RooCode](#cline-continue-roocode)
  - [Triển khai VPS](#triển-khai-vps)
  - [Docker](#docker)
  - [Biến môi trường](#biến-môi-trường)
  - [Tệp Runtime và Lưu trữ](#tệp-runtime-và-lưu-trữ)
- [📊 Các mô hình có sẵn](#-các-mô-hình-có-sẵn)
- [🐛 Khắc phục sự cố](#-khắc-phục-sự-cố)
- [🛠️ Tech Stack](#-tech-stack)
- [📝 Tài liệu tham khảo API](#-tài-liệu-tham-khảo-api)
  - [Chat Completions](#chat-completions)
  - [Liệt kê Mô hình](#liệt-kê-mô-hình)
  - [Các Endpoint Tương thích](#các-endpoint-tương-thích)
  - [Kịch bản Xác thực Đám mây](#kịch-bản-xác-thực-đám-mây)
  - [API Quản lý và Bảng điều khiển](#api-quản-lý-và-bảng-điều-khiển)
  - [Hành vi Xác thực](#hành-vi-xác-thực)
  - [Xử lý Yêu cầu (C cao)](#xử-lý-yêu-cầu-c-cao)
- [📧 Hỗ trợ](#-hỗ-trợ)
